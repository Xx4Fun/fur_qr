      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // Navigates to profile tab, but since we are in a tab view, this might just be cosmetic
            },
          ),
          const SizedBox(width: 8),
        ],
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: _OverviewCard(
                          title: "Community Scans Nearby", // Mock data text for UI purposes
                          count: _alertCount.toString(), // Using alert count for now
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {}, // Handled by bottom nav normally
